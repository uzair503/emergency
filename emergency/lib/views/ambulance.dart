      ...
      body: Stack(
        children: <Widget>[
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    }, child: Text("Accident"),style: ElevatedButton.styleFrom(
          ...
          Center(
                    ...
                    }, child: Text("Medical Emergency"),style: ElevatedButton.styleFrom(
                      primary: Color.fromARGB(255, 75, 16, 102), fixedSize: Size(300, 40),   shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(30.0),
                            ),
                    ),),
          ...
          Center(
                    ...
                    }, child: Text("Fire"),style: ElevatedButton.styleFrom(
                      primary: Color.fromARGB(255, 75, 16, 102), fixedSize: Size(300, 40),   shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(30.0),
                            ),
                    ),),
